...
if($_SERVER['REQUEST_METHOD'] == 'POST'){
	if(isset($_POST['info'])){
	    ...
	    if($action=="INCOMING"){
	    	$counter_referrals=$referral->get_incoming_counter_referral($hos_id);
	    }elseif($action=="OUTGOING"){
	    	$counter_referrals=$referral->get_outgoing_counter_referral($hos_id);
	    }
	    displayResult($counter_referrals,$function);
	}else{
...
function displayResult($counter_referrals,$function){
	?>
<div class="md-card">
