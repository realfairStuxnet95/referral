<?php 
$locations=array();
$locations=$super->get_hospitals_locations();
?>
<div id="top_bar">
            ...
            <div class="uk-width-medium-1-3">
                <div id="modal_overflow" class="uk-modal" style="margin-top: 40px;">
                    <div class="uk-modal-dialog">
                        ...
                        <h2 class="heading_a">Add new Hospital Location</h2>
                        <div class="md-card">
        ...
        <div class="uk-overflow-container">
            <table class="uk-table">
                ...
                <tr>
                    ...
                    <td><?php echo $value['region_title']; ?></td>
...
<script src="assets/js/super/location.js"></script>