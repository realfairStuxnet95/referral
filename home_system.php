            ...
            $type=$_SESSION['user_type'];
             if(isset($_GET['action'])){
                ...
                if($type=="SuperAdmin"){
                    switch ($action) {
                        case 'doctors':
                            include 'views/super/doctors.php';
                            break;
                        case 'system_settings':
                            include 'views/super/system_settings.php';
                            break;
                        case 'system_blog':
                            include 'views/super/system_blog.php';
                            break;
                        case 'update_blog':
                            include 'views/super/update_blog.php';
                            break;
                        case 'system_messages':
                            include 'views/super/system_messages.php';
                            break;
                        case 'hospitals':
                            include 'views/super/hospitals.php'; 
                            break;
                        case 'region':
                            include 'views/super/hospital_location.php';
                            break;
                        case 'category':
                            include 'views/super/hospital_categories.php';
                            break;
                        case 'departments':
                            include 'views/super/hospitals_departments.php';
                            break;
                        case 'nurses':
                            include 'views/super/nurses.php';
                            break;
                        case 'receptionists':
                            include 'views/super/receptionists.php';
                            break;
                        case 'transport':
                    ...
                    if($type=="HospitalAdmin"){
                        switch ($action) {
                            case 'departments':
                                include 'views/hospital/department.php'; 
                                break;
                            case 'doctors':
                                include 'views/hospital/doctors.php'; 
                                break;
                            case 'nurses':
                                include 'views/hospital/nurses.php'; 
                                break;
                            case 'receptionists':
                                include 'views/hospital/receptionist.php';
                                break;
                        ...
                        switch ($action) {
                        case 'outgoing_referrals':
                            include 'views/doctor/referrals.php';
                            break;
                        case 'incoming_referrals':
                            include 'views/doctor/incoming_referrals.php';
                            break;
                        case 'tabbed':
                            include 'views/doctor/tabbed_incoming_referral.php';
                            break;
