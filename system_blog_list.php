...
<!-- Mirrored from altair_html.tzdthemes.com/layout_top_menu.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 06 Feb 2018 11:17:08 GMT -->
<head>
    <meta charset="UTF-8">
    ...
    <title>News Blog - Referral System</title>
...
<body class="disable_transitions top_menu">
    <?php include 'blog_navs.php'; ?>
<div id="page_content">
        <div id="page_content_inner">

            <h4 class="heading_b uk-margin-bottom">Articles</h3>

            <div class="blog_list uk-grid-width-medium-1-3 uk-grid-width-large-1-4" data-uk-grid="{gutter: 24}">
                <?php 
$system_blog=array();
$system_blog=$super->get_blogs();
foreach ($system_blog as $key => $value) {
    ?>
    <div>
        <div class="md-card">
            <div class="md-card-content small-padding">
                ...
                if($value['file_name']!=""){
                    ?>
                <img src="system_images/blog/<?php echo $value['file_name'];?>" alt="" class="blog_list_teaser_image">
                    <?php
                ...
                <div class="blog_list_teaser">
                    ...
                    <p><?php 
                     if(strlen($value['description'])>100){
                        echo substr($value['description'], 0,100).'.....(More)';
                     }else{
                ...
                <div class="blog_list_footer">
                    <a href="blog?component=<?php echo $value['blog_id'];?>&title=<?php echo $value['blog_title'];?>" 
